        ...
        <div class="panel">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    {!! Form::open([
                        'url' => route('admin.v1.content-management.photos.edit-controller.execute', [
                            'photo_id' => 1
                        ]),
                        'class' => 'well',
                        'method' => 'POST',
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::textarea('photo_alt', 'Длина текста не должна быть меньше 3–4 слов и длиннее 250 символов.', [
                                'rows' => 2,
                        ...
                        <div class="form-group">
                            {{ Form::label('article_name', 'Выбрать новую фотографию:', [
                                'class' => 'control-label'
                            ]) }}
