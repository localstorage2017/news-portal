        ...
        <div class="panel">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    {!! Form::open([
                        'url' => route('admin.v1.content-management.sub-categories.edit-controller.execute', [
                            'sub_category_id' => 1
                        ]),
                        'class' => 'well',
                        'method' => 'POST'
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('sub_category_name', 'Подкатегория 1', [
                                 'class' => 'form-control',
                                 'id' => 'sub_category_name',
                                 'placeholder' => 'Новое название подкатегории'
                            ]) }}
                        </div>
